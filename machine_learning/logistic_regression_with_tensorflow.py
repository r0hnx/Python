...
"""
Implementing logistic regression with tensorflow for classification problem
Helpful resources:
...
if __name__ == "__main__":
  ...
  y_test, y_pred_logistic_reg = logistic_regression(X_moons_with_bias, y_moons_column_vector, X_moons_with_bias.shape[1], 50, 0.1, 250)
